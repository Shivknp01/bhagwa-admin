  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 select-none pb-16">
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border-color)] p-5 rounded-2xl space-y-4 shadow-xs">
        ...
        {/* FULL DEVOTIONAL TEXT & BODY CONTENT */}
        <div className="space-y-3 pt-2 border-t border-[var(--border-color)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <textarea
                rows={5}
                placeholder="Enter full mantra, sloka, stuti lyrics, quote, or devotional story..."
                value={contentBody}
            ...
            <div>
              ...
              <textarea
                rows={5}
                placeholder="संपूर्ण मंत्र, श्लोक, स्तुति, या कथा यहाँ लिखें..."
                value={contentBodyHi}
